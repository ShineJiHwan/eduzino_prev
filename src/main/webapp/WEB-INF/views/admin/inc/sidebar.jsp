  ...
  <li class="nav-item nav-profile border-bottom">
    ...
    <li class="nav-item pt-3">
      <a class="nav-link d-block" href="index.html">
        <img class="sidebar-brand-logo" src="/resources/teacher/assets/images/logo.svg" alt="" />
        <img class="sidebar-brand-logomini" src="/resources/teacher/assets/images/logo-mini.svg" alt="" />
